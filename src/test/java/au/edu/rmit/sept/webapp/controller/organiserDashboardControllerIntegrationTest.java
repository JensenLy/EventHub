...
public class organiserDashboardControllerIntegrationTest {
  ...
  /** Verifies dashboard lists events for the currently logged-in organiser. */
  @Test
  ...
  /** Verifies RSVPs view shows event details and attendee list for owned event. */
  @Test
  ...
  /** Verifies non-owned/missing event shows error and reloads dashboard list. */
  @Test
